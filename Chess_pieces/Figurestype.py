...
white_pawn = {'wp1' : white_pawn[0], 'wp2' : white_pawn[1], 'wp3' : white_pawn[2], 'wp4' : white_pawn[3], 'wp5' : white_pawn[4], 'wp6' : white_pawn[5], 'wp7' : white_pawn[6], 'wp8' : white_pawn[7]}
black_pawn = {'bp1' : black_pawn[0], 'bp2' : black_pawn[1], 'bp3' : black_pawn[2], 'bp4' : black_pawn[3], 'bp5' : black_pawn[4], 'bp6' : black_pawn[5], 'bp7' : black_pawn[6], 'bp8' : black_pawn[7]}
...
Figures = [white_castle, white_el, white_horse, white_king, white_queen, white_pawn, black_castle, black_el, black_horse, black_king, black_queen, black_pawn]
